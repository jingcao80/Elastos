...
AutoPtr<IASN1Choice> CDistributionPointName::initASN1()
{
    ...
    assert(0);
    //CASN1Explicit::New(0, GeneralNames::ASN1, (IASN1Explicit**)&explicit0);
    AutoPtr<IASN1Explicit> explicit1;
    assert(0);
    //CASN1Implicit::New(1, IASN1Type::Probe(CName::ASN1_RDN), (IASN1Explicit**)&explicit1);
...
AutoPtr<IASN1Choice> CDistributionPointName::ASN1 = initASN1();
