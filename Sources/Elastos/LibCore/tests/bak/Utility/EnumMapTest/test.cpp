...
int CTest::test_ConstructorLjava_lang_Class(int argc, char* argv[])
{
    // try {
    AutoPtr<IEnumMap> em;
    InterfaceID interid;
    ECode ec = CEnumMap::New(interid, (IEnumMap**)&em);
    if (ec != NOERROR) {
        printf("Expected NullPointerException~~~~~~~\n");
    }
    ...
    // try {
    interid = EIID_IInteger32;
    ec = CEnumMap::New(interid, (IEnumMap**)&em);
    if (ec != NOERROR) {
        printf("Expected NullPointerException~~~~~~~\n");
    }
    // } catch (NullPointerException e) {
    ...
    // AutoPtr<IEnumMap> enumColorMap;
    // CEnumMap::New(Color.class);
...
int CTest::test_ConstructorLjava_util_EnumMap(int argc, char* argv[])
{
    // EnumMap enumMap;
...
int CTest::testSerializationSelf(int argc, char* argv[])
{
    // EnumMap enumColorMap = new EnumMap<Color, Double>(Color.class);
    // enumColorMap.put(Color.Blue, 3);
...
int CTest::testSerializationCompatibility(int argc, char* argv[])
{
    // EnumMap enumColorMap = new EnumMap<Color, Double>(Color.class);
    // enumColorMap.put(Color.Red, 1);
    // enumColorMap.put(Color.Blue, 3);
