...
PTestEntry TestEntry[] =
{
    ...
    &CTest::test_putPresent,
    &CTest::test_putAllLjava_util_Map,
    &CTest::test_putAll_Ljava_util_Map_Null,
    &CTest::test_entrySet,
    &CTest::test_entrySetRemove,
    &CTest::test_keySet,
    &CTest::test_values,
    &CTest::test_removeLjava_lang_Object,
    &CTest::test_clear,
    &CTest::test_clone,
    &CTest::test_clone_ordered,
    &CTest::test_clone_Mock,
    &CTest::test_removeEldestFromSameBucketAsNewEntry,
    &CTest::test_containsKeyLjava_lang_Object,
    &CTest::test_containsValueLjava_lang_Object,
    &CTest::test_isEmpty,
    &CTest::test_size,
    &CTest::test_ordered_entrySet,
    &CTest::test_ordered_keySet,
    &CTest::test_ordered_values,
    &CTest::test_remove_eldest,
};
