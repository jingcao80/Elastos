...
#include "elastos/apps/calculator/calculator2/CalculatorExpressionBuilder.h"
    ...
    /* [in] */ Float oldSize)
{
    ...
    oah->OfFloat(textView, View::SCALE_X.Get(), arr1.Get(), (IObjectAnimator**)&o1);
    AutoPtr<IObjectAnimator> o2;
    oah->OfFloat(textView, View::SCALE_Y.Get(), arr1.Get(), (IObjectAnimator**)&o2);
    AutoPtr<IObjectAnimator> o3;
    oah->OfFloat(textView, View::TRANSLATION_X.Get(), arr2.Get(), (IObjectAnimator**)&o3);
    AutoPtr<IObjectAnimator> o4;
    oah->OfFloat(textView, View::TRANSLATION_Y.Get(), arr3.Get(), (IObjectAnimator**)&o4);
    ...
    /* [in] */ IAnimatorListener* listener)
{
    ...
    oah->OfFloat(revealView.Get(), View::ALPHA.Get(), arr.Get(), (IObjectAnimator**)&oba);
    ...
    /* [in] */ const String& result)
{
    ...
    oah->OfFloat(ICalculatorEditText::Probe(mResultEditText), View::SCALE_X.Get(), arr1.Get(), (IObjectAnimator**)&ioa);
    (*animators)[1] = IAnimator::Probe(ioa);
    ioa = NULL;
    oah->OfFloat(ICalculatorEditText::Probe(mResultEditText), View::SCALE_Y.Get(), arr1.Get(), (IObjectAnimator**)&ioa);
    (*animators)[2] = IAnimator::Probe(ioa);
    ioa = NULL;
    oah->OfFloat(ICalculatorEditText::Probe(mResultEditText), View::TRANSLATION_X.Get(), arr2.Get(), (IObjectAnimator**)&ioa);
    (*animators)[3] = IAnimator::Probe(ioa);
    ioa = NULL;
    oah->OfFloat(ICalculatorEditText::Probe(mFormulaEditText), View::TRANSLATION_Y.Get(), arr3.Get(), (IObjectAnimator**)&ioa);
    (*animators)[4] = IAnimator::Probe(ioa);
    ioa = NULL;
    oah->OfFloat(ICalculatorEditText::Probe(mFormulaEditText), View::TRANSLATION_Y.Get(), arr4.Get(), (IObjectAnimator**)&ioa);
