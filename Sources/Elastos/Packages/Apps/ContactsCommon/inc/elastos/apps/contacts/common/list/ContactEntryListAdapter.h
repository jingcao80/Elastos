#ifndef __ELASTOS_APPS_CONTACTS_COMMON_LIST_CONTACTENTRYLISTADAPTER_H__
#define __ELASTOS_APPS_CONTACTS_COMMON_LIST_CONTACTENTRYLISTADAPTER_H__
...
private:
    static const String TAG; // = "ContactEntryListAdapter";

    Int32 mDisplayOrder;
    Int32 mSortOrder;

    Boolean mDisplayPhotos;
    Boolean mCircularPhotos; // = true;
    ...
    Int32 mDirectoryResultLimit = Integer.MAX_VALUE;

    Boolean mEmptyListEnabled; // = true;
...
#endif //__ELASTOS_APPS_CONTACTS_COMMON_LIST_CONTACTENTRYLISTADAPTER_H__
