...
private:
    static const String KEY_DATA_STATE;// = "data_state";
    static const String KEY_SERVICE_STATE;// = "service_state";
    static const String KEY_OPERATOR_NAME;// = "operator_name";
    static const String KEY_ROAMING_STATE;// = "roaming_state";
    static const String KEY_NETWORK_TYPE;// = "network_type";
    static const String KEY_LATEST_AREA_INFO;// = "latest_area_info";
    static const String KEY_PHONE_NUMBER;// = "number";
    static const String KEY_IMEI_SV;// = "imei_sv";
    static const String KEY_IMEI;// = "imei";
    static const String KEY_PRL_VERSION;// = "prl_version";
    static const String KEY_MIN_NUMBER;// = "min_number";
    static const String KEY_MEID_NUMBER;// = "meid_number";
    static const String KEY_SIGNAL_STRENGTH;// = "signal_strength";
    static const String KEY_BATTERY_STATUS;// = "battery_status";
    static const String KEY_BATTERY_LEVEL;// = "battery_level";
    static const String KEY_IP_ADDRESS;// = "wifi_ip_address";
    static const String KEY_WIFI_MAC_ADDRESS;// = "wifi_mac_address";
    static const String KEY_BT_ADDRESS;// = "bt_address";
    static const String KEY_SERIAL_NUMBER;// = "serial_number";
    static const String KEY_ICC_ID;// = "icc_id";
    static const String KEY_WIMAX_MAC_ADDRESS;// = "wimax_mac_address";
    ...
    static const Int32 EVENT_SIGNAL_STRENGTH_CHANGED;// = 200;
    static const Int32 EVENT_SERVICE_STATE_CHANGED;// = 300;

    static const Int32 EVENT_UPDATE_STATS;// = 500;

    static const Int32 EVENT_UPDATE_CONNECTIVITY;// = 600;
    ...
    AutoPtr<BroadcastReceiver> mBatteryInfoReceiver;// = new InitBatteryInfoReceiver(this);


    AutoPtr<PhoneStateListener> mPhoneStateListener;// = new InitPhoneStateListener(this);


    AutoPtr<BroadcastReceiver> mAreaInfoReceiver;// = new InitAreaInfoReceiver(this);

    AutoPtr<IIntentFilter> mConnectivityIntentFilter;
    AutoPtr<BroadcastReceiver> mConnectivityReceiver;// = new InitConnectivityReceiver(this);
};
