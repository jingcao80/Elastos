...
// private:
//     class MeasurementHandler extends Handler {
...
public:
    static const AutoPtr<IComponentName> DEFAULT_CONTAINER_COMPONENT;// = new ComponentName(
...
// private:
//     static const String TAG = "StorageMeasurement";

//     static const Boolean LOCAL_LOGV = TRUE;

//     static const String DEFAULT_CONTAINER_PACKAGE = "com.android.defcontainer";

//     /** Media types to measure on external storage. */
//     static const Set<String> sMeasureMediaTypes = Sets->NewHashSet(
...
//     static HashMap<StorageVolume, StorageMeasurement> sInstances = Maps->NewHashMap();

//     volatile WeakReference<MeasurementReceiver> mReceiver;

//     /** Physical volume being measured, or {@code NULL} for internal. */
//     StorageVolume mVolume;
