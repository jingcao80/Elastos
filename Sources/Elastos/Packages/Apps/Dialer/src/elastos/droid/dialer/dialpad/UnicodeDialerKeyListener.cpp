...
#include "elastos/droid/dialer/dialpad/CUnicodeDialerKeyListener.h"
...
CAR_INTERFACE_IMPL(UnicodeDialerKeyListener, /*DialerKeyListener*/Object, IUnicodeDialerKeyListener);
