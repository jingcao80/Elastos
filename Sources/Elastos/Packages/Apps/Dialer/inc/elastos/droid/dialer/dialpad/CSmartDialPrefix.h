#ifndef __ELASTOS_DROID_DIALER_DIALPAD_CSMARTDIALPREFIX_H__
#define __ELASTOS_DROID_DIALER_DIALPAD_CSMARTDIALPREFIX_H__

#include "_Elastos_Droid_Dialer_Dialpad_CSmartDialPrefix.h"
...
#endif //__ELASTOS_DROID_DIALER_DIALPAD_CSMARTDIALPREFIX_H__
