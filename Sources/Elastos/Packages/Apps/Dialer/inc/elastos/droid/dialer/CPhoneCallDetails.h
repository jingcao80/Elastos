#ifndef __ELASTOS_DROID_DIALER_CPHONECALLDETAILS_H__
#define __ELASTOS_DROID_DIALER_CPHONECALLDETAILS_H__

#include "_Elastos_Droid_Dialer_CPhoneCallDetails.h"
...
#endif //__ELASTOS_DROID_DIALER_CPHONECALLDETAILS_H__
