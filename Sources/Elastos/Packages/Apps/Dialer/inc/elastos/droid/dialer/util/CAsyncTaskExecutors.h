#ifndef __ELASTOS_DROID_DIALER_UTIL_CASYNCTASKEXECUTORS_H__
#define __ELASTOS_DROID_DIALER_UTIL_CASYNCTASKEXECUTORS_H__

#include "_Elastos_Droid_Dialer_Util_CAsyncTaskExecutors.h"
...
#endif //__ELASTOS_DROID_DIALER_UTIL_CASYNCTASKEXECUTORS_H__
