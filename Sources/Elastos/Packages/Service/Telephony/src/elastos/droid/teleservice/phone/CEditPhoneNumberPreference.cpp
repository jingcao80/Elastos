...
#include "elastos/droid/teleservice/phone/CEditPhoneNumberPreference.h"
    ...
    /* [in] */ IAttributeSet* attrs)
{
    ...
    SetDialogLayoutResource(Elastos::Droid::TeleService::R::layout::pref_dialog_editphonenumber);
    ...
    assert(0);
    // context->ObtainStyledAttributes(attrs, Elastos::Droid::TeleService::R::styleable::EditPhoneNumberPreference, 0,
    //         Elastos::Droid::TeleService::R::style::EditPhoneNumberPreference, (ITypedArray**)&a);
    String str;
    a->GetString(Elastos::Droid::TeleService::R::styleable::EditPhoneNumberPreference_enableButtonText, &str);
    mEnableText = CoreUtils::Convert(str);
    a->GetString(Elastos::Droid::TeleService::R::styleable::EditPhoneNumberPreference_disableButtonText, &str);
    mDisableText = CoreUtils::Convert(str);
    a->GetString(Elastos::Droid::TeleService::R::styleable::EditPhoneNumberPreference_changeNumButtonText, &str);
    mChangeNumberText = CoreUtils::Convert(str);
    a->GetInt32(Elastos::Droid::TeleService::R::styleable::EditPhoneNumberPreference_confirmMode, 0, &mConfirmationMode);
    a->Recycle();
    ...
    /* [in] */ IView* view)
{
    ...
    AutoPtr<IView> _view;
    view->FindViewById(Elastos::Droid::TeleService::R::id::select_contact, (IView**)&_view);
    ...
    /* [in] */IEditText* editText)
{
    ...
    AutoPtr<IView> view;
    dialogView->FindViewById(Elastos::Droid::TeleService::R::id::edit_container, (IView**)&view);
    ...
    /* [in] */ IAlertDialogBuilder* builder)
{
    ...
    return builder->SetIcon(Elastos::Droid::TeleService::R::mipmap::ic_launcher_phone);
}
