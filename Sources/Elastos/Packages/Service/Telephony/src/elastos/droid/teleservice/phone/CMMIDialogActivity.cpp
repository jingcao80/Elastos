...
#include "elastos/droid/teleservice/phone/CMMIDialogActivity.h"
        ...
        /* [in] */ IBundle* savedInstanceState)
{
    ...
    if (state == PhoneConstantsState_OFFHOOK) {
        ...
        helper->MakeText(this, Elastos::Droid::TeleService::R::string::incall_status_dialed_mmi, IToast::LENGTH_SHORT, (IToast**)&toast);
        toast->Show();
    }
    ShowMMIDialog();
    return NOERROR;
