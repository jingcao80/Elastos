...
#ifndef __ELASTOS_DROID_PROVIDER_USERDICTIONARY_CDICTIONARYBACKUPAGENT_H__
#define __ELASTOS_DROID_PROVIDER_USERDICTIONARY_CDICTIONARYBACKUPAGENT_H__

#include "_Elastos_Droid_Providers_UserDictionary_CDictionaryBackupAgent.h"
 ...
 */
CarClass(CDictionaryBackupAgent)
    , public ContentProvider
{
public:
    CAR_OBJECT_DECL()

    CDictionaryBackupAgent();
...
private:
    static const String KEY_DICTIONARY = "userdictionary";

    static const Int32 STATE_DICTIONARY = 0;
    static const Int32 STATE_SIZE = 1;

    static const String SEPARATOR = "|";

    static const byte[] EMPTY_DATA = new byte[0];

    static const String TAG = "DictionaryBackupAgent";

    static const Int32 COLUMN_WORD = 1;
    static const Int32 COLUMN_FREQUENCY = 2;
    static const Int32 COLUMN_LOCALE = 3;
    static const Int32 COLUMN_APPID = 4;
    static const Int32 COLUMN_SHORTCUT = 5;

    static const String[] PROJECTION = {
        IUserDictionaryWords::_ID,
        IUserDictionaryWords::WORD,
        IUserDictionaryWords::FREQUENCY,
        IUserDictionaryWords::LOCALE,
        IUserDictionaryWords::APP_ID,
        IUserDictionaryWords::SHORTCUT
    };
};
...
#endif // __ELASTOS_DROID_PROVIDER_USERDICTIONARY_CDICTIONARYBACKUPAGENT_H__
