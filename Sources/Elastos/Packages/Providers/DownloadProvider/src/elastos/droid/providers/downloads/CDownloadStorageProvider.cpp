    ...
    /* [out] */ ICursor** result)
{
    ...
    row->Add(IDocumentsContractRoot::COLUMN_ROOT_ID, CoreUtils::Convert(DOC_ID_ROOT));
    row->Add(IDocumentsContractRoot::COLUMN_FLAGS,
        CoreUtils::Convert(IDocumentsContractRoot::FLAG_LOCAL_ONLY |
        IDocumentsContractRoot::FLAG_SUPPORTS_RECENTS |
        IDocumentsContractRoot::FLAG_SUPPORTS_CREATE));
    row->Add(IDocumentsContractRoot::COLUMN_ICON, CoreUtils::Convert(R::mipmap::ic_launcher_download));
    String str;
    cxt->GetString(R::string::root_downloads, &str);
    row->Add(IDocumentsContractRoot::COLUMN_TITLE, CoreUtils::Convert(str));
    row->Add(IDocumentsContractRoot::COLUMN_DOCUMENT_ID, CoreUtils::Convert(DOC_ID_ROOT));
    ...
    /* [out] */ String* result)
{
    ...
    if (IDocumentsContractDocument::MIME_TYPE_DIR.Equals(mimeType)) {
        Logger::D(Constants::TAG, "Directory creation not supported");
    ...
    mDm->AddCompletedDownload(
            name, name, TRUE, mimeType, path, 0LL,
            FALSE, TRUE, &id);
    ...
    /* [in] */ IMatrixCursor* result)
{
    ...
    row->Add(IDocumentsContractDocument::COLUMN_DOCUMENT_ID, CoreUtils::Convert(DOC_ID_ROOT));
    ...
    row->Add(IDocumentsContractDocument::COLUMN_FLAGS,
        CoreUtils::Convert(IDocumentsContractDocument::FLAG_DIR_PREFERS_LAST_MODIFIED |
    ...
    /* [in] */ ICursor* cursor)
{
    ...
    row->Add(IDocumentsContractDocument::COLUMN_DISPLAY_NAME, CoreUtils::Convert(displayName));
    row->Add(IDocumentsContractDocument::COLUMN_SUMMARY, CoreUtils::Convert(summary));
    row->Add(IDocumentsContractDocument::COLUMN_SIZE, CoreUtils::Convert(size));
    row->Add(IDocumentsContractDocument::COLUMN_MIME_TYPE, CoreUtils::Convert(mimeType));
    row->Add(IDocumentsContractDocument::COLUMN_LAST_MODIFIED, CoreUtils::Convert(lastModified));
    row->Add(IDocumentsContractDocument::COLUMN_FLAGS, CoreUtils::Convert(flags));
}
