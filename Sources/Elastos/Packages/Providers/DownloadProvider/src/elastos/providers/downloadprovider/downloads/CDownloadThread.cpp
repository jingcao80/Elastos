...
#include "elastos/providers/downloadprovider/downloads/CDownloadDrmHelper.h"
#include "elastos/providers/downloadprovider/downloads/CStorageUtils.h"
...
using Elastos::Providers::DownloadProvider::Downloads::NetworkState;
    ...
    /* [in] */ IHttpURLConnection* conn)
{
    ...
    // try {
        ...
        // try {
            ...
            Int64 res = 0;
            Os::Lseek(outFd, mInfoDelta->mCurrentBytes, OsConstants::_SEEK_SET, &res);
