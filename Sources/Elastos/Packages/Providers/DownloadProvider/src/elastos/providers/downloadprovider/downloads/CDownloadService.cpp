...
#include "elastos/providers/downloadprovider/downloads/CDownloadService.h"
#include "elastos/providers/downloadprovider/downloads/Constants.h"
#include "elastos/providers/downloadprovider/downloads/CDownloadScanner.h"
...
AutoPtr<IExecutorService> CDownloadService::BuildDownloadExecutor()
{
    ...
    assert(0 && "TODO");
    AutoPtr<IThreadPoolExecutor> executor; // = new MyThreadPoolExecutor(
    //         maxConcurrent, maxConcurrent, 10, ITimeUnit::SECONDS,
    //         que);
...
Boolean CDownloadService::UpdateLocked()
{
    ...
    IContext::Probe(this)->GetContentResolver((IContentResolver**)&resolver);
    AutoPtr<IDownloadsImpl> impl;
    CDownloadsImpl::AcquireSingleton((IDownloadsImpl**)&impl);
    AutoPtr<IUri> uriDL;
    impl->GetALL_DOWNLOADS_CONTENT_URI((IUri**)&uriDL);
