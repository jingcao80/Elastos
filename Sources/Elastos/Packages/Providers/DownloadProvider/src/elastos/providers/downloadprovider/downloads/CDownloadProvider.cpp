...
#include "elastos/providers/downloadprovider/downloads/CDownloadProvider.h"
...
AutoPtr<ArrayOf<String> > CDownloadProvider::SqlSelection::GetParameters()
{
    ...
    assert(0 && "TODO");
    // mParameters->ToArray(array, (ArrayOf<String>**)&res);
    return res;
}
    ...
    /* [out] */ Boolean* result)
{
    ...
    assert(0 && "TODO");
    // CDatabaseHelper::New(cxt, (ISQLiteOpenHelper**)&mOpenHelper);
    ...
    pm->GetApplicationInfo(String("com.android.defcontainer"), 0, (IApplicationInfo**)&appInfo);
...
void CDownloadProvider::InsertRequestHeaders(
    /* [in] */ ISQLiteDatabase* db,
    /* [in] */ Int64 downloadId,
    /* [in] */ IContentValues* values)
{
    ...
    while ((iterator->HasNext(&bHasNxt), bHasNxt)) {
        ...
        if (key.StartWith(IDownloadsImplRequestHeaders::INSERT_KEY_PREFIX)) {
            ...
            assert(0 && "TODO");
            AutoPtr<ArrayOf<String> > parts;// = headerLine.Split(":", 2);
