...
#ifndef __ELASTOS_PROVIDERS_DOWNLOADPROVIDER_DOWNLOADS_CDOWNLOADPROVIDER_H__
#define __ELASTOS_PROVIDERS_DOWNLOADPROVIDER_DOWNLOADS_CDOWNLOADPROVIDER_H__
...
#include "_Elastos_Providers_DownloadProvider_Downloads_CDownloadProvider.h"
...
private:
     ...
     */
    CARAPI_(void) InsertRequestHeaders(
        /* [in] */ ISQLiteDatabase* db,
        /* [in] */ Int64 downloadId,
        /* [in] */ IContentValues* values);
...
#endif //__ELASTOS_PROVIDERS_DOWNLOADPROVIDER_DOWNLOADS_CDOWNLOADPROVIDER_H__
