...
#ifndef __Elastos_DevSamples_BroadcastDynamicDemo_R_H__
#define __Elastos_DevSamples_BroadcastDynamicDemo_R_H__
#include <elatypes.h>
namespace Elastos {
...
#endif // __Elastos_DevSamples_BroadcastDynamicDemo_R_H__
