...
#ifndef __Elastos_DevSamples_CustomViewDemo_R_H__
#define __Elastos_DevSamples_CustomViewDemo_R_H__
#include <elatypes.h>
namespace Elastos {
...
class ECO_PUBLIC R {
    ...
    public: class id {
        public: static const int ImageView = 0x7f050001;
...
#endif // __Elastos_DevSamples_CustomViewDemo_R_H__
