...
//     private static final Function EMPTY_FUNCS = {};
//     Function[] compileMultiple(Symbols symbols, String source) {
//         codeGen.setSymbols(symbols);
//         rpn.setConsumer(codeGen);
//         int len = symbols.length();
//         ArrayList<Function> funcs = new ArrayList<Function>();
//         try {
//             int pos = lexer.scan(source, rpn);
//             funcs.add(codeGen.getFun(codeGen.intrinsicArity));
//         } catch (SyntaxException e) {
//             // fall-through
//         }
//     }
