...
class SpannableStringBuilder {
    constructor(text) {
        var _obj = Droid_New("Elastos.Droid.Text.CSpannableStringBuilder", text);
        return _obj;
    }
}
...
class CalculatorExpressionBuilder extends SpannableStringBuilder {
...
//         mIsEdited = isEdited;
//     }
    constructor(text, tokenizer, isEdited) {
        super(text);
...
//     }
    Replace(start, end, tb, tbstart, tbend) {
        ...
        return retSpannableStringBuilder;
    }
