...
#ifndef __Elastos_Droid_DevSamples_SampleLauncher_R_H__
#define __Elastos_Droid_DevSamples_SampleLauncher_R_H__
namespace Elastos {
namespace Droid {
...
class R {
    ...
    public: class id {
        public: static const int myListView = 0x7f050000;
    };
    public: class layout {
...
#endif // __Elastos_Droid_DevSamples_SampleLauncher_R_H__
