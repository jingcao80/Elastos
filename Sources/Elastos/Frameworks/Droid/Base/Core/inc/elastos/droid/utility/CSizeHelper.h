...
#ifndef __ELASTOS_DROID_UTILITY_CSIZE_HELPER_H__
#define __ELASTOS_DROID_UTILITY_CSIZE_HELPER_H__

#include "_Elastos_Droid_Utility_CSizeHelper.h"
...
#endif // __ELASTOS_DROID_UTILITY_CSIZE_HELPER_H__
