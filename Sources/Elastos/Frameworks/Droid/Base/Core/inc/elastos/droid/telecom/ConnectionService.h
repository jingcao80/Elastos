#ifndef __ELASTOS_DROID_TELECOM_CONNECTIONSERVICE_H__
#define __ELASTOS_DROID_TELECOM_CONNECTIONSERVICE_H__
...
#endif //__ELASTOS_DROID_TELECOM_CONNECTIONSERVICE_H__
