...
#ifndef __ELASTOS_DROID_WEBKIT_WEBVIEW_CHROMIUM_MEDIA_VIDEOCAPTUREFACTORY_H__
#define __ELASTOS_DROID_WEBKIT_WEBVIEW_CHROMIUM_MEDIA_VIDEOCAPTUREFACTORY_H__
...
DEFINE_CONVERSION_FOR(Elastos::Droid::Webkit::Webview::Chromium::Media::VideoCaptureFactory::CamParams, IInterface);

#endif//__ELASTOS_DROID_WEBKIT_WEBVIEW_CHROMIUM_MEDIA_VIDEOCAPTUREFACTORY_H__
