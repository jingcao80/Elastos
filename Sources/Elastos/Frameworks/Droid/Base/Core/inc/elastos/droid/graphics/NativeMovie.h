...
#ifndef __ELASTOS_DROID_GRAPHICS_NATIVEMOVIE_H__
#define __ELASTOS_DROID_GRAPHICS_NATIVEMOVIE_H__
...
class NativeMovie : public SkRefCnt
{
public:
    /** Try to create a movie from the stream. If the stream format is not
        supported, return NULL.
    */
    static NativeMovie* DecodeStream(SkStreamRewindable*);
    ...
    */
    static NativeMovie* DecodeFile(const char path[]);
    /** Try to create a movie from the specified memory.
        ...
        it.
    */
    static NativeMovie* DecodeMemory(const void* data, size_t length);
...
#endif // __ELASTOS_DROID_GRAPHICS_NATIVEMOVIE_H__
