#ifndef __ELASTOS_DROID_TELECOMM_TELECOM_PHONEACCOUNT_H__
#define __ELASTOS_DROID_TELECOMM_TELECOM_PHONEACCOUNT_H__
...
#endif //__ELASTOS_DROID_TELECOMM_TELECOM_PHONEACCOUNT_H__