...
#ifndef __ELASTOS_DROID_INTERNAL_TELEPHONY_GSM_SMSMESSAGE_H__
#define __ELASTOS_DROID_INTERNAL_TELEPHONY_GSM_SMSMESSAGE_H__
...
#endif // __ELASTOS_DROID_INTERNAL_TELEPHONY_GSM_SMSMESSAGE_H__
