#ifndef __ELASTOS_DROID_TELECOMM_TELECOM_DISCONNECTCAUSE_H__
#define __ELASTOS_DROID_TELECOMM_TELECOM_DISCONNECTCAUSE_H__
...
#endif //__ELASTOS_DROID_TELECOMM_TELECOM_DISCONNECTCAUSE_H__