...
#ifndef __ELASTOS_DROID_INTERNAL_TELEPHONY_ICCUTILS_H__
#define __ELASTOS_DROID_INTERNAL_TELEPHONY_ICCUTILS_H__
...
#endif // __ELASTOS_DROID_INTERNAL_TELEPHONY_ICCUTILS_H__
