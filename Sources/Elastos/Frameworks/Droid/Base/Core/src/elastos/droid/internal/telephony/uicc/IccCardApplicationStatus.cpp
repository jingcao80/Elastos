...
public class IccCardApplicationStatus {
    ...
    public Int32            pin1_replaced;
    public PinState       pin1;
    public PinState       pin2;

    public AppType AppTypeFromRILInt(Int32 type) {
        AppType newType;
        /* RIL_AppType ril.h */
        Switch(type) {
    ...
    public AppState AppStateFromRILInt(Int32 state) {
        AppState newState;
        /* RIL_AppState ril.h */
        Switch(state) {
    ...
    public PersoSubState PersoSubstateFromRILInt(Int32 substate) {
    ...
    public PinState PinStateFromRILInt(Int32 state) {
