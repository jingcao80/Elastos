    ...
    /* [in] */ IParcel* source)
{
    ...
    source->ReadInterfacePtr((HANDLE*)(IInterface**)&breadCrumbShortTitle);
    ...
    source->ReadInterfacePtr((HANDLE*)(IInterface**)&fragmentArguments);
    mFragmentArguments = IBundle::Probe(fragmentArguments);
    AutoPtr<IInterface> intent;
    source->ReadInterfacePtr((HANDLE*)(IInterface**)&intent);
    mIntent = IIntent::Probe(intent);
    AutoPtr<IInterface> extras;
    source->ReadInterfacePtr((HANDLE*)(IInterface**)&extras);
