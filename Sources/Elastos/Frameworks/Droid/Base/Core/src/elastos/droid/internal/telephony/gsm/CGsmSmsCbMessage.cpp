    ...
    /* [out] */ ISmsCbMessage** result)
{
    ...
    //             NULL, String("ETWS"), ISmsCbMessage::MESSAGE_PRIORITY_EMERGENCY,
    //             header->GetEtwsInfo(), header->GetCmasInfo(), (ISmsCbMessage**)&result);
    // }
    // else {
    //     String language;
    //     StringBuilder sb;
    ...
    //         sb.Append(str);
    //     }
    //     Int32 priority = header->IsEmergencyMessage() ? ISmsCbMessage::MESSAGE_PRIORITY_EMERGENCY
    //             : ISmsCbMessage::MESSAGE_PRIORITY_NORMAL;

    //     String str;
    //     return CSmsCbMessage::New(ISmsCbMessage::MESSAGE_FORMAT_3GPP,
    //             header->GetGeographicalScope(), header->GetSerialNumber(), location,
    //             header->GetServiceCategory(), language, (sb.ToString(&str), str), priority,
    //             header->GetEtwsInfo(), header->GetCmasInfo(), (ISmsCbMessage**)&result);
    // }
    return NOERROR;
}
    ...
    /* [out] */ IPair** result)
{
    ...
    //     Int32 nrPages = (*pdu)[ISmsCbHeader::PDU_HEADER_LENGTH];

    //     if (pdu->GetLength() < ISmsCbHeader::PDU_HEADER_LENGTH + 1 + (PDU_BODY_PAGE_LENGTH + 1)
    //             * nrPages) {
    ...
    //         Int32 offset = ISmsCbHeader::PDU_HEADER_LENGTH + 1 + (PDU_BODY_PAGE_LENGTH + 1) * i;
    ...
    //         AutoPtr<IPair> p = UnpackBody(pdu, encoding, offset, length,
    ...
    //     Int32 offset = ISmsCbHeader::PDU_HEADER_LENGTH;
    ...
    /* [out] */ IPair** result)
{
    ...
    *result = NULL;
    ...
    //         // try {
    //         body = String(pdu, offset, (length & 0xfffe), "utf-16");
