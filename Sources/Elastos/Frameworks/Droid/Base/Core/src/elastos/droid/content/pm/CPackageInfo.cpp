    ...
    /* [in] */ IParcel* source)
{
    ...
    source->ReadArrayOf((HANDLE*)&mGids);
    source->ReadArrayOf((HANDLE*)&mActivities);
    source->ReadArrayOf((HANDLE*)&mReceivers);
    source->ReadArrayOf((HANDLE*)&mServices);
    source->ReadArrayOf((HANDLE*)&mProviders);
    source->ReadArrayOf((HANDLE*)&mInstrumentation);
    source->ReadArrayOf((HANDLE*)&mPermissions);
    source->ReadArrayOfString((ArrayOf<String>**)&mRequestedPermissions);
    source->ReadArrayOf((HANDLE*)&mRequestedPermissionsFlags);
    source->ReadArrayOf((HANDLE*)&mSignatures);
    source->ReadArrayOf((HANDLE*)&mConfigPreferences);
    source->ReadArrayOf((HANDLE*)&mReqFeatures);
    source->ReadArrayOf((HANDLE*)&mFeatureGroups);
    ...
    /* [in] */ IParcel* dest)
{
    ...
    dest->WriteArrayOf((HANDLE)mGids.Get());
    dest->WriteArrayOf((HANDLE)mActivities.Get());
    dest->WriteArrayOf((HANDLE)mReceivers.Get());
    dest->WriteArrayOf((HANDLE)mServices.Get());
    dest->WriteArrayOf((HANDLE)mProviders.Get());
    dest->WriteArrayOf((HANDLE)mInstrumentation.Get());
    dest->WriteArrayOf((HANDLE)mPermissions.Get());
    dest->WriteArrayOfString(mRequestedPermissions.Get());
    dest->WriteArrayOf((HANDLE)mRequestedPermissionsFlags.Get());
    dest->WriteArrayOf((HANDLE)mSignatures.Get());
    dest->WriteArrayOf((HANDLE)mConfigPreferences.Get());
    dest->WriteArrayOf((HANDLE)mReqFeatures.Get());
    dest->WriteArrayOf((HANDLE)mFeatureGroups.Get());
