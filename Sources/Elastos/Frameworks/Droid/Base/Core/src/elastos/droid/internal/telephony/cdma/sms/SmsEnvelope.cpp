...
public class SmsEnvelope {
     ...
     */
    static public final Int32 MESSAGE_TYPE_POINT_TO_POINT   = 0x00;
    static public final Int32 MESSAGE_TYPE_BROADCAST        = 0x01;
    static public final Int32 MESSAGE_TYPE_ACKNOWLEDGE      = 0x02;

    /**
     * Supported Teleservices
     * (See 3GPP2 N.S0005 and TIA-41)
     */
    static public final Int32 TELESERVICE_NOT_SET           = 0x0000;
    static public final Int32 TELESERVICE_WMT               = 0x1002;
    static public final Int32 TELESERVICE_VMN               = 0x1003;
    static public final Int32 TELESERVICE_WAP               = 0x1004;
    static public final Int32 TELESERVICE_WEMT              = 0x1005;
    static public final Int32 TELESERVICE_SCPT              = 0x1006;
    static public final Int32 TELESERVICE_CT_WAP            = 0xFDEA;
    ...
    static public final Int32 TELESERVICE_MWI               = 0x40000;

    // Service Categories for Cell Broadcast, see 3GPP2 C.R1001 table 9.3.1-1
    // static const Int32 SERVICE_CATEGORY_EMERGENCY      = 0x0001;
    //...

    // CMAS alert service category assignments, see 3GPP2 C.R1001 table 9.3.3-1
    public static const Int32 SERVICE_CATEGORY_CMAS_PRESIDENTIAL_LEVEL_ALERT  = 0x1000;
    public static const Int32 SERVICE_CATEGORY_CMAS_EXTREME_THREAT            = 0x1001;
    public static const Int32 SERVICE_CATEGORY_CMAS_SEVERE_THREAT             = 0x1002;
    public static const Int32 SERVICE_CATEGORY_CMAS_CHILD_ABDUCTION_EMERGENCY = 0x1003;
    public static const Int32 SERVICE_CATEGORY_CMAS_TEST_MESSAGE              = 0x1004;
    public static const Int32 SERVICE_CATEGORY_CMAS_LAST_RESERVED_VALUE       = 0x10ff;
     ...
     */
    public Int32 teleService = TELESERVICE_NOT_SET;
