...
public enum DcFailCause {
    ...
    private final Boolean mRestartRadioOnRegularDeactivation = Resources->GetSystem()->GetBoolean(
            R.bool.config_restart_radio_on_pdp_fail_regular_deactivation);
    private final Int32 mErrorCode;
    private static const HashMap<Integer, DcFailCause> sErrorCodeToFailCauseMap;
    static {
    ...
    public Boolean IsPermanentFail() {
        ...
        If (this == ACTIVATION_REJECT_GGSN) {
            Return (context->GetResources().
                    GetBoolean(R.bool.config_reject_ggsn_perm_failure));
        } else If (this == PROTOCOL_ERRORS) {
            Return (context->GetResources().
                    GetBoolean(R.bool.config_protocol_errors_perm_failure));
        } else {
    ...
    public static DcFailCause FromInt(Int32 errorCode) {
