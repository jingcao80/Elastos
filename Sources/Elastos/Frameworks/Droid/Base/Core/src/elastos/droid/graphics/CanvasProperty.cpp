...
Int64 CanvasProperty::nCreateFloat(
    /* [in] */ Float initialValue)
{
    return reinterpret_cast<Int64>(new android::uirenderer::CanvasPropertyPrimitive(initialValue));
}

Int64 CanvasProperty::nCreatePaint(
    /* [in] */ Int64 initialValuePaintPtr)
{
    const android::Paint* paint = reinterpret_cast<const android::Paint*>(initialValuePaintPtr);
    return reinterpret_cast<Int64>(new android::uirenderer::CanvasPropertyPaint(*paint));
}
