...
public interface AppInterface {
     ...
     * status is requested.
     */
    public static const String CHECK_SCREEN_IDLE_ACTION =
     ...
     * arrives.
     */
    public static const String CAT_ACTIVATE_NOTIFY_ACTION =
     ...
     */
    public static const String CAT_HCI_CONNECTIVITY_ACTION =
    ...
    public static enum CommandType {
         ...
         *         returned.
         */
        public static CommandType FromInt(Int32 value) {
