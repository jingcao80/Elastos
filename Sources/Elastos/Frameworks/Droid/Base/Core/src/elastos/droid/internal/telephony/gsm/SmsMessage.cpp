...
const String SmsMessage::TAG("SmsMessage");
const Boolean SmsMessage::VDBG = TRUE;
const Int32 SmsMessage::VALIDITY_PERIOD_FORMAT_NONE;
const Int32 SmsMessage::VALIDITY_PERIOD_FORMAT_ENHANCED;
const Int32 SmsMessage::VALIDITY_PERIOD_FORMAT_RELATIVE;
const Int32 SmsMessage::VALIDITY_PERIOD_FORMAT_ABSOLUTE;
const Int32 SmsMessage::VALIDITY_PERIOD_MIN;
...
SmsMessage::PduParser::PduParser(
    /* [in] */ ArrayOf<Byte>* pdu)
    : mPdu(pdu)
    , mCur(0)
...
ECode SmsMessage::PduParser::GetSCAddress(
    /* [out] */ String* result)
{
...
ECode SmsMessage::PduParser::GetByte(
    /* [out] */ Int32* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::PduParser::GetAddress(
...
ECode SmsMessage::PduParser::GetSCTimestampMillis(
    /* [out] */ Int64* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::PduParser::ConstructUserData(
...
ECode SmsMessage::PduParser::GetUserData(
...
ECode SmsMessage::PduParser::GetUserDataHeader(
...
ECode SmsMessage::PduParser::GetUserDataGSM7Bit(
...
ECode SmsMessage::PduParser::GetUserDataGSM8bit(
    /* [in] */ Int32 byteCount,
    /* [out] */ String* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::PduParser::GetUserDataUCS2(
    /* [in] */ Int32 byteCount,
    /* [out] */ String* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::PduParser::GetUserDataKSC5601(
    /* [in] */ Int32 byteCount,
    /* [out] */ String* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::PduParser::MoreDataPresent(
    /* [out] */ Boolean* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::constructor()
{
    return NOERROR;
}

ECode SmsMessage::CreateFromPdu(
    /* [in] */ ArrayOf<Byte>* pdu,
    /* [out] */ ISmsMessage** result)
{
    ...
    ((SmsMessage*)msg.Get())->ParsePdu(pdu);
    *result = msg;
    REFCOUNT_ADD(*result)
    ...
    /* [out] */ ISmsMessage** result)
{
    ...
    AutoPtr<ISmsMessage> msg;
    CSmsMessage::New((ISmsMessage**)&msg);
    ((SmsMessage*)msg.Get())->ParsePdu(IccUtils::HexStringToBytes((*lines)[1]));
    *result = msg;
    REFCOUNT_ADD(*result)
    return NOERROR;
    // } catch (RuntimeException ex) {
    ...
    /* [out] */ ISmsMessage** result)
{
    ...
    AutoPtr<ISmsMessage> msg;
    CSmsMessage::New((ISmsMessage**)&msg);
    ((SmsMessage*)msg.Get())->ParsePdu(IccUtils::HexStringToBytes(line));
    *result = msg;
    REFCOUNT_ADD(*result)
    return NOERROR;
    // } catch (RuntimeException ex) {
...
ECode SmsMessage::CreateFromEfRecord(
    /* [in] */ Int32 index,
    ...
    /* [out] */ ISmsMessage** result)
{
    ...
    ((SmsMessage*)msg.Get())->mIndexOnIcc = index;
    ...
    if (((*data)[0] & 1) == 0) {
        ...
        *result = NULL;
        ...
        ((SmsMessage*)msg.Get())->mStatusOnIcc = (*data)[0] & 0x07;
    }
...
ECode SmsMessage::GetTPLayerLengthForPDU(
    /* [in] */ const String& pdu,
    /* [out] */ Int32* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::GetRelativeValidityPeriod(
    ...
    /* [out] */ ISmsMessageSubmitPdu** result)
{
    return GetSubmitPdu(scAddress, destinationAddress, message,
            statusReportRequested, (ArrayOf<Byte>*)NULL, result);
}
...
ECode SmsMessage::CalculateLength(
...
ECode SmsMessage::GetDataCodingScheme(
    /* [out] */ Int32* result)
{
    VALIDATE_NOT_NULL(result)
...
ECode SmsMessage::IsUsimDataDownload(
    /* [out] */ Boolean* result)
{
    VALIDATE_NOT_NULL(result)
...
AutoPtr<ArrayOf<Byte> > SmsMessage::EncodeUCS2(
    /* [in] */ const String& message,
    /* [in] */ ArrayOf<Byte>* header)
{
    AutoPtr<ArrayOf<Byte> > userData;
...
AutoPtr<IByteArrayOutputStream> SmsMessage::GetSubmitPduHead(
    /* [in] */ const String& scAddress,
    /* [in] */ const String& destinationAddress,
    /* [in] */ Byte mtiByte,
    /* [in] */ Boolean statusReportRequested,
...
void SmsMessage::ParseSmsStatusReport(
    /* [in] */ PduParser* p,
    /* [in] */ Int32 firstByte)
{
...
void SmsMessage::ParseSmsDeliver(
    /* [in] */ PduParser* p,
    /* [in] */ Int32 firstByte)
{
    ...
    if (mOriginatingAddress != NULL) {
        String addressStr;
        mOriginatingAddress->GetAddressString(&addressStr);
        if (VDBG) Logger::V(TAG, "SMS originating address:%s ", addressStr.string());
    }
...
void SmsMessage::ParseSmsSubmit(
    /* [in] */ PduParser* p,
    /* [in] */ Int32 firstByte)
{
    mReplyPathPresent = (firstByte & 0x80) == 0x80;
