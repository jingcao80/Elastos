...
const Int32 PhoneBase::EVENT_RADIO_AVAILABLE             = 1;
const Int32 PhoneBase::EVENT_SSN                         = 2;
const Int32 PhoneBase::EVENT_SIM_RECORDS_LOADED          = 3;
const Int32 PhoneBase::EVENT_MMI_DONE                    = 4;
const Int32 PhoneBase::EVENT_RADIO_ON                    = 5;
const Int32 PhoneBase::EVENT_GET_BASEBAND_VERSION_DONE   = 6;
const Int32 PhoneBase::EVENT_USSD                        = 7;
const Int32 PhoneBase::EVENT_RADIO_OFF_OR_NOT_AVAILABLE  = 8;
const Int32 PhoneBase::EVENT_GET_IMEI_DONE               = 9;
const Int32 PhoneBase::EVENT_GET_IMEISV_DONE             = 10;
const Int32 PhoneBase::EVENT_GET_SIM_STATUS_DONE         = 11;
const Int32 PhoneBase::EVENT_SET_CALL_FORWARD_DONE       = 12;
const Int32 PhoneBase::EVENT_GET_CALL_FORWARD_DONE       = 13;
const Int32 PhoneBase::EVENT_CALL_RING                   = 14;
const Int32 PhoneBase::EVENT_CALL_RING_CONTINUE          = 15;
const Int32 PhoneBase::EVENT_SET_NETWORK_MANUAL_COMPLETE    = 16;
const Int32 PhoneBase::EVENT_SET_NETWORK_AUTOMATIC_COMPLETE = 17;
const Int32 PhoneBase::EVENT_SET_CLIR_COMPLETE              = 18;
const Int32 PhoneBase::EVENT_REGISTERED_TO_NETWORK          = 19;
const Int32 PhoneBase::EVENT_SET_VM_NUMBER_DONE             = 20;
const Int32 PhoneBase::EVENT_GET_DEVICE_IDENTITY_DONE       = 21;
const Int32 PhoneBase::EVENT_RUIM_RECORDS_LOADED            = 22;
const Int32 PhoneBase::EVENT_NV_READY                       = 23;
const Int32 PhoneBase::EVENT_SET_ENHANCED_VP                = 24;
const Int32 PhoneBase::EVENT_EMERGENCY_CALLBACK_MODE_ENTER  = 25;
const Int32 PhoneBase::EVENT_EXIT_EMERGENCY_CALLBACK_RESPONSE = 26;
const Int32 PhoneBase::EVENT_CDMA_SUBSCRIPTION_SOURCE_CHANGED = 27;
const Int32 PhoneBase::EVENT_SET_NETWORK_AUTOMATIC          = 28;
const Int32 PhoneBase::EVENT_ICC_RECORD_EVENTS              = 29;
const Int32 PhoneBase::EVENT_ICC_CHANGED                    = 30;
const Int32 PhoneBase::EVENT_SRVCC_STATE_CHANGED            = 31;
const Int32 PhoneBase::EVENT_INITIATE_SILENT_REDIAL         = 32;
const Int32 PhoneBase::EVENT_UNSOL_OEM_HOOK_RAW             = 33;
const Int32 PhoneBase::EVENT_SS                             = 34;
const Int32 PhoneBase::EVENT_SET_CALL_FORWARD_TIMER_DONE    = 35;
const Int32 PhoneBase::EVENT_GET_CALL_FORWARD_TIMER_DONE    = 36;
const Int32 PhoneBase::EVENT_LAST                   = EVENT_GET_CALL_FORWARD_TIMER_DONE;
