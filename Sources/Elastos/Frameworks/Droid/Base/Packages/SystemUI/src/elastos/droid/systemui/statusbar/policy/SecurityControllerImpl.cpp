...
const String SecurityControllerImpl::TAG("SecurityController");
const Boolean SecurityControllerImpl::DEBUG = Logger::IsLoggable(TAG, Logger::___DEBUG);
...
AutoPtr<INetworkRequest> SecurityControllerImpl::InitStatic()
{
