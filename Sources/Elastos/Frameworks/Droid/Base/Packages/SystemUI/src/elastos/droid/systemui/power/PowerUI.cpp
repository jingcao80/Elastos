...
PowerUI::Receiver::Receiver(
    /* [in] */ PowerUI* host)
    : mHost(host)
{}

ECode PowerUI::Receiver::Init()
{
...
void PowerUI::Receiver::UpdateSaverMode()
{
...
ECode PowerUI::Receiver::OnReceive(
    /* [in] */ IContext* context,
    /* [in] */ IIntent* intent)
{
    String action;
...
const String PowerUI::TAG("PowerUI");
const Boolean PowerUI::DEBUG = Logger::IsLoggable(TAG.string(), Logger::___DEBUG);

CAR_INTERFACE_IMPL(PowerUI, SystemUI, IPowerUI)
...
ECode PowerUI::SetSaverMode(
    /* [in] */ Boolean mode)
{
    return mWarnings->ShowSaverMode(mode);
}

ECode PowerUI::UpdateBatteryWarningLevels()
{
...
Int32 PowerUI::FindBatteryLevelBucket(
    /* [in] */ Int32 level)
{
