...
#include "elastos/droid/packages/systemui/doze/CDozeService.h"
#include "elastos/droid/packages/systemui/doze/DozeLog.h"
...
using Elastos::Droid::Packages::SystemUI::StatusBar::Phone::IPulseSchedule;
