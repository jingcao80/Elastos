...
const Int64 TrustDrawable::ENTERING_FROM_UNSET_START_DELAY = 200;
const Int64 TrustDrawable::VISIBLE_DURATION = 1000;
const Int64 TrustDrawable::EXIT_DURATION = 500;
const Int64 TrustDrawable::ENTER_DURATION = 500;
const Int32 TrustDrawable::ALPHA_VISIBLE_MIN = 0x26;
const Int32 TrustDrawable::ALPHA_VISIBLE_MAX = 0x4c;
const Int32 TrustDrawable::STATE_UNSET = -1;
const Int32 TrustDrawable::STATE_GONE = 0;
const Int32 TrustDrawable::STATE_ENTERING = 1;
const Int32 TrustDrawable::STATE_VISIBLE = 2;
const Int32 TrustDrawable::STATE_EXITING = 3;
TrustDrawable::StateUpdateAnimatorListener::StateUpdateAnimatorListener(
    /* [in] */ TrustDrawable* host)
    : mHost(host)
    , mCancelled(FALSE)
{}

ECode TrustDrawable::StateUpdateAnimatorListener::OnAnimationStart(
...
ECode TrustDrawable::StateUpdateAnimatorListener::OnAnimationCancel(
    /* [in] */ IAnimator* animation)
{
    mCancelled = TRUE;
    return NOERROR;
...
ECode TrustDrawable::StateUpdateAnimatorListener::OnAnimationEnd(
    /* [in] */ IAnimator* animation)
{
    if (!mCancelled) {
...
CAR_INTERFACE_IMPL(TrustDrawable::AlphaUpdateListener, Object, IAnimatorUpdateListener);
TrustDrawable::AlphaUpdateListener::AlphaUpdateListener(
    /* [in] */ TrustDrawable* host)
    : mHost(host)
{}

ECode TrustDrawable::AlphaUpdateListener::OnAnimationUpdate(
...
CAR_INTERFACE_IMPL(TrustDrawable::RadiusUpdateListener, Object, IAnimatorUpdateListener);
TrustDrawable::RadiusUpdateListener::RadiusUpdateListener(
    /* [in] */ TrustDrawable* host)
    : mHost(host)
{}

ECode TrustDrawable::RadiusUpdateListener::OnAnimationUpdate(
    /* [in] */ IValueAnimator* animation)
{
    AutoPtr<IInterface> obj;
    animation->GetAnimatedValue((IInterface**)&obj);
...
ECode TrustDrawable::SetColorFilter(
    /* [in] */ IColorFilter* cf)
{
...
ECode TrustDrawable::GetOpacity(
    /* [out] */ Int32* opacity)
{
...
void TrustDrawable::SetTrustManaged(
...
void TrustDrawable::UpdateState(
    /* [in] */ Boolean animate)
{
...
AutoPtr<IAnimator> TrustDrawable::MakeVisibleAnimator()
{
...
AutoPtr<IAnimator> TrustDrawable::MakeEnterAnimator(
    /* [in] */ Float radius,
    /* [in] */ Int32 alpha)
{
...
AutoPtr<IAnimator> TrustDrawable::MakeExitAnimator(
    /* [in] */ Float radius,
    /* [in] */ Int32 alpha)
{
...
AutoPtr<IAnimator> TrustDrawable::MakeAnimators(
...
AutoPtr<IValueAnimator> TrustDrawable::ConfigureAnimator(
