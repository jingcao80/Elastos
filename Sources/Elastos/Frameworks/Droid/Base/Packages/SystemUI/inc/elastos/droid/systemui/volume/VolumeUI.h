...
#ifndef __ELASTOS_DROID_SYSTEMUI_VOLUME_VOLUMEUI_H__
#define __ELASTOS_DROID_SYSTEMUI_VOLUME_VOLUMEUI_H__
...
#endif //__ELASTOS_DROID_SYSTEMUI_VOLUME_VOLUMEUI_H__