...
final class HdmiConfig {
    ...
    static const Int32 TIMEOUT_MS = 2000;
    ...
    static const Int32 RETRANSMISSION_COUNT = 1;
    ...
    static const Boolean HIDE_DEVICES_BEHIND_LEGACY_SWITCH = TRUE;
