...
final class HdmiCecKeycode {
    public static const Int32 UNSUPPORTED_KEYCODE = -1;
    public static const Int32 NO_PARAM = -1;

    // =========================================================================
    // Hdmi CEC keycodes
    public static const Int32 CEC_KEYCODE_SELECT = 0x00;
    public static const Int32 CEC_KEYCODE_UP = 0x01;
    public static const Int32 CEC_KEYCODE_DOWN = 0x02;
    public static const Int32 CEC_KEYCODE_LEFT = 0x03;
    public static const Int32 CEC_KEYCODE_RIGHT = 0x04;
    public static const Int32 CEC_KEYCODE_RIGHT_UP = 0x05;
    public static const Int32 CEC_KEYCODE_RIGHT_DOWN = 0x06;
    public static const Int32 CEC_KEYCODE_LEFT_UP = 0x07;
    public static const Int32 CEC_KEYCODE_LEFT_DOWN = 0x08;
    public static const Int32 CEC_KEYCODE_ROOT_MENU = 0x09;
    public static const Int32 CEC_KEYCODE_SETUP_MENU = 0x0A;
    public static const Int32 CEC_KEYCODE_CONTENTS_MENU = 0x0B;
    public static const Int32 CEC_KEYCODE_FAVORITE_MENU = 0x0C;
    public static const Int32 CEC_KEYCODE_EXIT = 0x0D;
    // RESERVED = 0x0E - 0x0F
    public static const Int32 CEC_KEYCODE_MEDIA_TOP_MENU = 0x10;
    public static const Int32 CEC_KEYCODE_MEDIA_CONTEXT_SENSITIVE_MENU = 0x11;
    // RESERVED = 0x12 – 0x1C
    public static const Int32 CEC_KEYCODE_NUMBER_ENTRY_MODE = 0x1D;
    public static const Int32 CEC_KEYCODE_NUMBER_11 = 0x1E;
    public static const Int32 CEC_KEYCODE_NUMBER_12 = 0x1F;
    public static const Int32 CEC_KEYCODE_NUMBER_0_OR_NUMBER_10 = 0x20;
    public static const Int32 CEC_KEYCODE_NUMBERS_1 = 0x21;
    public static const Int32 CEC_KEYCODE_NUMBERS_2 = 0x22;
    public static const Int32 CEC_KEYCODE_NUMBERS_3 = 0x23;
    public static const Int32 CEC_KEYCODE_NUMBERS_4 = 0x24;
    public static const Int32 CEC_KEYCODE_NUMBERS_5 = 0x25;
    public static const Int32 CEC_KEYCODE_NUMBERS_6 = 0x26;
    public static const Int32 CEC_KEYCODE_NUMBERS_7 = 0x27;
    public static const Int32 CEC_KEYCODE_NUMBERS_8 = 0x28;
    public static const Int32 CEC_KEYCODE_NUMBERS_9 = 0x29;
    public static const Int32 CEC_KEYCODE_DOT = 0x2A;
    public static const Int32 CEC_KEYCODE_ENTER = 0x2B;
    public static const Int32 CEC_KEYCODE_CLEAR = 0x2C;
    // RESERVED = 0x2D - 0x2E
    public static const Int32 CEC_KEYCODE_NEXT_FAVORITE = 0x2F;
    public static const Int32 CEC_KEYCODE_CHANNEL_UP = 0x30;
    public static const Int32 CEC_KEYCODE_CHANNEL_DOWN = 0x31;
    public static const Int32 CEC_KEYCODE_PREVIOUS_CHANNEL = 0x32;
    public static const Int32 CEC_KEYCODE_SOUND_SELECT = 0x33;
    public static const Int32 CEC_KEYCODE_INPUT_SELECT = 0x34;
    public static const Int32 CEC_KEYCODE_DISPLAY_INFORMATION = 0x35;
    public static const Int32 CEC_KEYCODE_HELP = 0x36;
    public static const Int32 CEC_KEYCODE_PAGE_UP = 0x37;
    public static const Int32 CEC_KEYCODE_PAGE_DOWN = 0x38;
    // RESERVED = 0x39 - 0x3F
    public static const Int32 CEC_KEYCODE_POWER = 0x40;
    public static const Int32 CEC_KEYCODE_VOLUME_UP = 0x41;
    public static const Int32 CEC_KEYCODE_VOLUME_DOWN = 0x42;
    public static const Int32 CEC_KEYCODE_MUTE = 0x43;
    public static const Int32 CEC_KEYCODE_PLAY = 0x44;
    public static const Int32 CEC_KEYCODE_STOP = 0x45;
    public static const Int32 CEC_KEYCODE_PAUSE = 0x46;
    public static const Int32 CEC_KEYCODE_RECORD = 0x47;
    public static const Int32 CEC_KEYCODE_REWIND = 0x48;
    public static const Int32 CEC_KEYCODE_FAST_FORWARD = 0x49;
    public static const Int32 CEC_KEYCODE_EJECT = 0x4A;
    public static const Int32 CEC_KEYCODE_FORWARD = 0x4B;
    public static const Int32 CEC_KEYCODE_BACKWARD = 0x4C;
    public static const Int32 CEC_KEYCODE_STOP_RECORD = 0x4D;
    public static const Int32 CEC_KEYCODE_PAUSE_RECORD = 0x4E;
    public static const Int32 CEC_KEYCODE_RESERVED = 0x4F;
    public static const Int32 CEC_KEYCODE_ANGLE = 0x50;
    public static const Int32 CEC_KEYCODE_SUB_PICTURE = 0x51;
    public static const Int32 CEC_KEYCODE_VIDEO_ON_DEMAND = 0x52;
    public static const Int32 CEC_KEYCODE_ELECTRONIC_PROGRAM_GUIDE = 0x53;
    public static const Int32 CEC_KEYCODE_TIMER_PROGRAMMING = 0x54;
    public static const Int32 CEC_KEYCODE_INITIAL_CONFIGURATION = 0x55;
    public static const Int32 CEC_KEYCODE_SELECT_BROADCAST_TYPE = 0x56;
    public static const Int32 CEC_KEYCODE_SELECT_SOUND_PRESENTATION = 0x57;
    // RESERVED = 0x58-0x5F
    public static const Int32 CEC_KEYCODE_PLAY_FUNCTION = 0x60;
    public static const Int32 CEC_KEYCODE_PAUSE_PLAY_FUNCTION = 0x61;
    public static const Int32 CEC_KEYCODE_RECORD_FUNCTION = 0x62;
    public static const Int32 CEC_KEYCODE_PAUSE_RECORD_FUNCTION = 0x63;
    public static const Int32 CEC_KEYCODE_STOP_FUNCTION = 0x64;
    public static const Int32 CEC_KEYCODE_MUTE_FUNCTION = 0x65;
    public static const Int32 CEC_KEYCODE_RESTORE_VOLUME_FUNCTION = 0x66;
    public static const Int32 CEC_KEYCODE_TUNE_FUNCTION = 0x67;
    public static const Int32 CEC_KEYCODE_SELECT_MEDIA_FUNCTION = 0x68;
    public static const Int32 CEC_KEYCODE_SELECT_AV_INPUT_FUNCTION = 0x69;
    public static const Int32 CEC_KEYCODE_SELECT_AUDIO_INPUT_FUNCTION = 0x6A;
    public static const Int32 CEC_KEYCODE_POWER_TOGGLE_FUNCTION = 0x6B;
    public static const Int32 CEC_KEYCODE_POWER_OFF_FUNCTION = 0x6C;
    public static const Int32 CEC_KEYCODE_POWER_ON_FUNCTION = 0x6D;
    // RESERVED = 0x6E-0x70
    public static const Int32 CEC_KEYCODE_F1_BLUE = 0x71;
    public static const Int32 CEC_KEYCODE_F2_RED = 0x72;
    public static const Int32 CEC_KEYCODE_F3_GREEN = 0x73;
    public static const Int32 CEC_KEYCODE_F4_YELLOW = 0x74;
    public static const Int32 CEC_KEYCODE_F5 = 0x75;
    public static const Int32 CEC_KEYCODE_DATA = 0x76;
    // RESERVED = 0x77-0xFF

    // =========================================================================
    // UI Broadcast Type
    public static const Int32 UI_BROADCAST_TOGGLE_ALL = 0x00;
    public static const Int32 UI_BROADCAST_TOGGLE_ANALOGUE_DIGITAL = 0x01;
    public static const Int32 UI_BROADCAST_ANALOGUE = 0x10;
    public static const Int32 UI_BROADCAST_ANALOGUE_TERRESTRIAL = 0x20;
    public static const Int32 UI_BROADCAST_ANALOGUE_CABLE = 0x30;
    public static const Int32 UI_BROADCAST_ANALOGUE_SATELLITE = 0x40;
    public static const Int32 UI_BROADCAST_DIGITAL = 0x50;
    public static const Int32 UI_BROADCAST_DIGITAL_TERRESTRIAL = 0x60;
    public static const Int32 UI_BROADCAST_DIGITAL_CABLE = 0x70;
    public static const Int32 UI_BROADCAST_DIGITAL_SATELLITE = 0x80;
    public static const Int32 UI_BROADCAST_DIGITAL_COMMNICATIONS_SATELLITE = 0x90;
    public static const Int32 UI_BROADCAST_DIGITAL_COMMNICATIONS_SATELLITE_2 = 0x91;
    public static const Int32 UI_BROADCAST_IP = 0xA0;

    // =========================================================================
    // UI Sound Presentation Control
    public static const Int32 UI_SOUND_PRESENTATION_SOUND_MIX_DUAL_MONO = 0x20;
    public static const Int32 UI_SOUND_PRESENTATION_SOUND_MIX_KARAOKE = 0x30;
    public static const Int32 UI_SOUND_PRESENTATION_SELECT_AUDIO_DOWN_MIX = 0x80;
    public static const Int32 UI_SOUND_PRESENTATION_SELECT_AUDIO_AUTO_REVERBERATION = 0x90;
    public static const Int32 UI_SOUND_PRESENTATION_SELECT_AUDIO_AUTO_EQUALIZER = 0xA0;
    public static const Int32 UI_SOUND_PRESENTATION_BASS_STEP_PLUS = 0xB1;
    public static const Int32 UI_SOUND_PRESENTATION_BASS_NEUTRAL = 0xB2;
    public static const Int32 UI_SOUND_PRESENTATION_BASS_STEP_MINUS = 0xB3;
    public static const Int32 UI_SOUND_PRESENTATION_TREBLE_STEP_PLUS = 0xC1;
    public static const Int32 UI_SOUND_PRESENTATION_TREBLE_NEUTRAL = 0xC2;
    public static const Int32 UI_SOUND_PRESENTATION_TREBLE_STEP_MINUS = 0xC3;
    ...
    private static class KeycodeEntry {
        private final Int32 mAndroidKeycode;
        private final Int32 mCecKeycode;
        private final Boolean mIsRepeatable;

        private KeycodeEntry(Int32 androidKeycode, Int32 cecKeycode, Boolean isRepeatable) {
            mAndroidKeycode = androidKeycode;
            mCecKeycode = cecKeycode;
            mIsRepeatable = isRepeatable;
        }

        private KeycodeEntry(Int32 androidKeycode, Int32 cecKeycode) {
            This(androidKeycode, cecKeycode, TRUE);
        }

        private Int32 ToCecKeycodeIfMatched(Int32 androidKeycode) {
        ...
        private Int32 ToAndroidKeycodeIfMatched(Int32 cecKeycode) {
        ...
        private Boolean IsRepeatableIfMatched(Int32 androidKeycode) {
            if (mAndroidKeycode == androidKeycode) {
    ...
    private static const KeycodeEntry[] KEYCODE_ENTRIES = new KeycodeEntry[] {
            new KeycodeEntry(KeyEvent.KEYCODE_DPAD_CENTER, CEC_KEYCODE_SELECT),
     ...
     */
    static Int32 AndroidKeyToCecKey(Int32 keycode) {
        for (Int32 i = 0; i < KEYCODE_ENTRIES.length; ++i) {
     ...
     */
    static Int32 CecKeyToAndroidKey(Int32 keycode) {
        for (Int32 i = 0; i < KEYCODE_ENTRIES.length; ++i) {
     ...
     */
    static Boolean IsRepeatableKey(Int32 androidKeycode) {
        for (Int32 i = 0; i < KEYCODE_ENTRIES.length; ++i) {
     ...
     */
    static Boolean IsSupportedKeycode(Int32 androidKeycode) {
