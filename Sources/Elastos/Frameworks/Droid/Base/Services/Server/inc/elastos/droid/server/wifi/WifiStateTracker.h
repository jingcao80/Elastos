...
#ifndef __ELASTOS_DROID_SERVER_WIFI_WIFISTATETRACKER_H__
#define __ELASTOS_DROID_SERVER_WIFI_WIFISTATETRACKER_H__
...
#endif  // __ELASTOS_DROID_SERVER_WIFI_WIFISTATETRACKER_H__
