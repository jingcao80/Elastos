...
using Elastos::lang.annotation.ElementType;
using Elastos::lang.annotation.Retention;
using Elastos::lang.annotation.RetentionPolicy;
using Elastos::lang.annotation.Target;
