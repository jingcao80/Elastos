...
const Int32 ActivityStackSupervisor::IDLE_TIMEOUT = 10*1000;
const Int32 ActivityStackSupervisor::SLEEP_TIMEOUT = 60*1000;//5*1000;      // changed for detecting memory leak
const Int32 ActivityStackSupervisor::LAUNCH_TIMEOUT = 60*1000;//10*1000;    // changed for detecting memory leak
