...
{
#endif
    extern void Elastos_AwPermissionRequest_nativeOnAccept(IInterface* caller,HANDLE nativeAwPermissionRequest,Boolean allowed);
    extern void Elastos_AwPermissionRequest_InitCallback(HANDLE cb);
#ifdef __cplusplus
}
#endif
...
{
    AutoPtr<IInterface> (*elastos_AwPermissionRequest_create)(HANDLE nativeAwPermissionRequest, const String& url, Int64 resources);
...
void* AwPermissionRequest::ElaAwPermissionRequestCallback_Init()
{
    ...
    Elastos_AwPermissionRequest_InitCallback((HANDLE)&sElaAwPermissionRequestCallback);
