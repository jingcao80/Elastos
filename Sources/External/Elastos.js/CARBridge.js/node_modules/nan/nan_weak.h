...
# if 0 // Some C++ compilers CANNOT work here!!
    v8::Local<v8::Object> _self = self->As<v8::Object>();
    v8::Local<v8::Object> *__self = &_self;
# else
    v8::Local<v8::Object> *__self = reinterpret_cast<v8::Local<v8::Object> *>(self);
# endif

    int count = (*__self)->InternalFieldCount();
    void *internal_fields[kInternalFieldsInWeakCallback] = {0, 0};
    for (int i = 0; i < count && i < kInternalFieldsInWeakCallback; i++) {
      internal_fields[i] = (*__self)->GetAlignedPointerFromInternalField(i);
    }
    wcbd = new WeakCallbackInfo<P>(
        reinterpret_cast<Persistent<v8::Value>*>(this)
      , callback
      ...
      , internal_fields[0]
      , internal_fields[1]);
    (*__self)->SetAlignedPointerInInternalField(0, wcbd);
    v8::PersistentBase<T>::SetWeak(
