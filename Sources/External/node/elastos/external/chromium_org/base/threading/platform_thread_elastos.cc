...
#include "base/elastos/api/ThreadUtils_api.h"
...
void PlatformThread::SetThreadPriority(PlatformThreadHandle handle,
  ...
  if (priority == kThreadPriority_RealtimeAudio) {
    ...
    //LLJava_ThreadUtils_setThreadPriorityAudio(env, PlatformThread::CurrentId());
    ////32/64 dependency code, pay attention to the parameter type
    DCHECK(sElaThreadUtilsCallback);
    sElaThreadUtilsCallback->elastos_ThreadUtils_setThreadPriorityAudio(PlatformThread::CurrentId());
    return;
  }
