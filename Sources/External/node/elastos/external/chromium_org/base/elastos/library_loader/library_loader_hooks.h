...
BASE_EXPORT bool RegisterLibraryLoaderEntryHook();
...
// TODO from the above description, I thinkd maybe we do not need this,
// need more check, library_loader_hooks.cc/LibraryLoaded
typedef bool LibraryLoadedHook(Elastos::ArrayOf<Elastos::String>* init_command_line);
