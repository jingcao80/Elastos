...
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> altGlyphDefConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGAltGlyphDefElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> altGlyphConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGAltGlyphElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> altGlyphItemConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGAltGlyphItemElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> fontConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGFontElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> font_faceConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGFontFaceElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> font_face_formatConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGFontFaceFormatElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> font_face_nameConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGFontFaceNameElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> font_face_srcConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGFontFaceSrcElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> font_face_uriConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGFontFaceUriElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> glyphConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGGlyphElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> glyphRefConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGGlyphRefElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> hkernConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGHKernElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> missing_glyphConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGMissingGlyphElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
static PassRefPtrWillBeRawPtr<SVGElement> vkernConstructor(
    Document& document,
    bool createdByParser)
{
    return SVGVKernElement::create(document);
}
#endif // ENABLE(SVG_FONTS)
...
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
        { font_faceTag, font_faceConstructor },
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
        { font_face_formatTag, font_face_formatConstructor },
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
        { font_face_nameTag, font_face_nameConstructor },
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
        { font_face_srcTag, font_face_srcConstructor },
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
        { font_face_uriTag, font_face_uriConstructor },
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
...
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
        { missing_glyphTag, missing_glyphConstructor },
#endif // ENABLE(SVG_FONTS)
#if ENABLE(SVG_FONTS)
