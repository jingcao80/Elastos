...
case 12: {
if (LIKELY((name[0] | 0x20) == 'h' && (name[1] | 0x20) == 'o' && (name[2] | 0x20) == 's' && (name[3] | 0x20) == 't' && name[4] == '-' && (name[5] | 0x20) == 'c' && (name[6] | 0x20) == 'o' && (name[7] | 0x20) == 'n' && (name[8] | 0x20) == 't' && (name[9] | 0x20) == 'e' && (name[10] | 0x20) == 'x' && (name[11] | 0x20) == 't')) {
...
if (length == 10) {
if (LIKELY((name[0] | 0x20) == 'w' && (name[1] | 0x20) == 'e' && (name[2] | 0x20) == 'b' && (name[3] | 0x20) == 'k' && (name[4] | 0x20) == 'i' && (name[5] | 0x20) == 't' && name[6] == '-' && (name[7] | 0x20) == 'a' && (name[8] | 0x20) == 'n' && (name[9] | 0x20) == 'y')) {
            m_token = ANYFUNCTION;
}
} else if (LIKELY(length == 11)) {
