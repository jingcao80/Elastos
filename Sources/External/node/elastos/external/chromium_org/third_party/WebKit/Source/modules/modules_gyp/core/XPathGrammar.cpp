...
/* Line 268 of yacc.c  */
#line 106 "/home/whm/kt_work/Android/CM12_0-Android501/out/target/product/victara/obj/GYP/shared_intermediates/blink/core/XPathGrammar.cpp"
...
/* Line 293 of yacc.c  */
#line 177 "/home/whm/kt_work/Android/CM12_0-Android501/out/target/product/victara/obj/GYP/shared_intermediates/blink/core/XPathGrammar.cpp"
} YYSTYPE;
...
/* Line 343 of yacc.c  */
#line 197 "/home/whm/kt_work/Android/CM12_0-Android501/out/target/product/victara/obj/GYP/shared_intermediates/blink/core/XPathGrammar.cpp"
...
#line 293 "xml/XPathGrammar.y"
    {
        (yyval.predList) = new WillBeHeapVector<OwnPtrWillBeMember<Predicate> >;
        (yyval.predList)->append(adoptPtrWillBeNoop(new Predicate(adoptPtrWillBeNoop((yyvsp[(1) - (1)].expr)))));
...
#line 301 "xml/XPathGrammar.y"
    {
        (yyval.predList)->append(adoptPtrWillBeNoop(new Predicate(adoptPtrWillBeNoop((yyvsp[(2) - (2)].expr)))));
...
#line 389 "xml/XPathGrammar.y"
    {
        (yyval.argList) = new WillBeHeapVector<OwnPtrWillBeMember<Expression> >;
        (yyval.argList)->append(adoptPtrWillBeNoop((yyvsp[(1) - (1)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (1)].expr));
...
#line 397 "xml/XPathGrammar.y"
    {
        (yyval.argList)->append(adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
...
#line 411 "xml/XPathGrammar.y"
    {
        ...
        (yyval.expr)->addSubExpression(adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)));
        (yyval.expr)->addSubExpression(adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
...
#line 454 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new Filter(adoptPtrWillBeNoop((yyvsp[(1) - (2)].expr)), *(yyvsp[(2) - (2)].predList));
...
#line 466 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new LogicalOp(LogicalOp::OP_Or, adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)), adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (3)].expr));
        parser->unregisterParseNode((yyvsp[(3) - (3)].expr));
        parser->registerParseNode((yyval.expr));
    }
...
#line 478 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new LogicalOp(LogicalOp::OP_And, adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)), adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (3)].expr));
        parser->unregisterParseNode((yyvsp[(3) - (3)].expr));
        parser->registerParseNode((yyval.expr));
    }
...
#line 490 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new EqTestOp((yyvsp[(2) - (3)].eqop), adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)), adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (3)].expr));
        parser->unregisterParseNode((yyvsp[(3) - (3)].expr));
        parser->registerParseNode((yyval.expr));
    }
...
#line 514 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new NumericOp(NumericOp::OP_Add, adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)), adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (3)].expr));
        parser->unregisterParseNode((yyvsp[(3) - (3)].expr));
        parser->registerParseNode((yyval.expr));
    }
...
#line 522 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new NumericOp(NumericOp::OP_Sub, adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)), adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (3)].expr));
        parser->unregisterParseNode((yyvsp[(3) - (3)].expr));
        parser->registerParseNode((yyval.expr));
    }
...
#line 534 "xml/XPathGrammar.y"
    {
        (yyval.expr) = new NumericOp((yyvsp[(2) - (3)].numop), adoptPtrWillBeNoop((yyvsp[(1) - (3)].expr)), adoptPtrWillBeNoop((yyvsp[(3) - (3)].expr)));
        parser->unregisterParseNode((yyvsp[(1) - (3)].expr));
        parser->unregisterParseNode((yyvsp[(3) - (3)].expr));
        parser->registerParseNode((yyval.expr));
    }
...
#line 546 "xml/XPathGrammar.y"
    {
        ...
        (yyval.expr)->addSubExpression(adoptPtrWillBeNoop((yyvsp[(2) - (2)].expr)));
        parser->unregisterParseNode((yyvsp[(2) - (2)].expr));
        parser->registerParseNode((yyval.expr));
    }
    break;
...
/* Line 1806 of yacc.c  */
#line 2054 "/home/whm/kt_work/Android/CM12_0-Android501/out/target/product/victara/obj/GYP/shared_intermediates/blink/core/XPathGrammar.cpp"
      default: break;
    }
