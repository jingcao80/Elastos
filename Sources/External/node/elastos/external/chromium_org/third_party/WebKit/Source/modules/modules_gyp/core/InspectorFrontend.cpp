...
InspectorFrontend::InspectorFrontend(InspectorFrontendChannel* inspectorFrontendChannel)
    ...
    , m_geolocation(inspectorFrontendChannel)
...
void InspectorFrontend::DOM::inspectNodeRequested(int nodeId)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
...
void InspectorFrontend::Timeline::progress(double count)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
    jsonMessage->setString("method", "Timeline.progress");
    RefPtr<JSONObject> paramsObject = JSONObject::create();
    paramsObject->setNumber("count", count);
    jsonMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
...
void InspectorFrontend::Timeline::started(const bool* const consoleTimeline)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
    jsonMessage->setString("method", "Timeline.started");
    RefPtr<JSONObject> paramsObject = JSONObject::create();
    if (consoleTimeline)
        paramsObject->setBoolean("consoleTimeline", *consoleTimeline);
    jsonMessage->setObject("params", paramsObject);
    if (m_inspectorFrontendChannel)
        m_inspectorFrontendChannel->sendMessageToFrontend(jsonMessage.release());
}

void InspectorFrontend::Timeline::stopped(const bool* const consoleTimeline)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
    jsonMessage->setString("method", "Timeline.stopped");
    RefPtr<JSONObject> paramsObject = JSONObject::create();
    if (consoleTimeline)
        paramsObject->setBoolean("consoleTimeline", *consoleTimeline);
    jsonMessage->setObject("params", paramsObject);
...
void InspectorFrontend::Worker::dispatchMessageFromWorker(int workerId, PassRefPtr<JSONObject> message)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
...
void InspectorFrontend::Canvas::contextCreated(const TypeBuilder::Page::FrameId& frameId)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
...
void InspectorFrontend::Canvas::traceLogsRemoved(const TypeBuilder::Page::FrameId* const frameId, const TypeBuilder::Canvas::TraceLogId* const traceLogId)
{
    RefPtr<JSONObject> jsonMessage = JSONObject::create();
