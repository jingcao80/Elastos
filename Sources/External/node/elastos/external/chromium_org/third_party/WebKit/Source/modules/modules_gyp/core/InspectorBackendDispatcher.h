...
public:
    ...
    public:
        ...
        virtual void setDeviceMetricsOverride(ErrorString*, int in_width, int in_height, double in_deviceScaleFactor, bool in_emulateViewport, bool in_fitWindow, const bool* in_textAutosizing, const double* in_fontScaleFactor) = 0;
