...
void StyleBuilder::applyProperty(CSSPropertyID property, StyleResolverState& state, CSSValue* value, bool isInitial, bool isInherit) {
    ...
    case CSSPropertyInternalMarqueeDirection:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyInternalMarqueeDirection(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyInternalMarqueeDirection(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyInternalMarqueeDirection(state, value);
        return;
    ...
    case CSSPropertyTouchActionDelay:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyTouchActionDelay(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyTouchActionDelay(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyTouchActionDelay(state, value);
        return;
    ...
    case CSSPropertyInternalMarqueeSpeed:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyInternalMarqueeSpeed(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyInternalMarqueeSpeed(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyInternalMarqueeSpeed(state, value);
        return;
    ...
    case CSSPropertyInternalCallback:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyInternalCallback(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyInternalCallback(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyInternalCallback(state, value);
        return;
    ...
    case CSSPropertyFont:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyFont(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyFont(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyFont(state, value);
        return;
    ...
    case CSSPropertyInternalMarqueeRepetition:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyInternalMarqueeRepetition(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyInternalMarqueeRepetition(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyInternalMarqueeRepetition(state, value);
        return;
    ...
    case CSSPropertyInternalMarqueeIncrement:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyInternalMarqueeIncrement(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyInternalMarqueeIncrement(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyInternalMarqueeIncrement(state, value);
        return;
    ...
    case CSSPropertyInternalMarqueeStyle:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyInternalMarqueeStyle(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyInternalMarqueeStyle(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyInternalMarqueeStyle(state, value);
        return;
    ...
    case CSSPropertyWebkitPerspective:
        if (isInitial)
            StyleBuilderFunctions::applyInitialCSSPropertyWebkitPerspective(state);
        else if (isInherit)
            StyleBuilderFunctions::applyInheritCSSPropertyWebkitPerspective(state);
        else
            StyleBuilderFunctions::applyValueCSSPropertyWebkitPerspective(state, value);
        return;
