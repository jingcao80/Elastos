...
V8StorageQuotaCallback::V8StorageQuotaCallback(v8::Handle<v8::Function> callback, ScriptState* scriptState)
...
void V8StorageQuotaCallback::handleEvent(unsigned long long grantedQuotaInBytes)
{
    ...
    v8::Handle<v8::Value> grantedQuotaInBytesHandle = v8::Number::New(isolate, static_cast<double>(grantedQuotaInBytes));
    if (grantedQuotaInBytesHandle.IsEmpty()) {
        if (!isScriptControllerTerminating())
            CRASH();
        return;
    }
    v8::Handle<v8::Value> argv[] = { grantedQuotaInBytesHandle };
